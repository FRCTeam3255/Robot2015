...
public class RobotPreferences {
	...
	public static double cassetteRaiseSpeed() {
		double liftSpeed = Preferences.getInstance().getDouble("CassetteLiftSpeed", 1.00);
	...
	public static double autoFwdTrashDistance() {
		return Preferences.getInstance().getDouble("AutoFwdTrashDistance", 6.5);
	}
